...
public class BasicTest {
	...
	@Test
	public void testRepoDownloadViaOrganisation()
	...
	@Test
	public void testListOfReposWithLicenseInfo()
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Test
	public void testListOfReposWithStatusInfo()
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Test
	public void testRecentCommitterDetails()
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	@Test
	public void testSummaryGenerationMain()
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
	...
	public void testBadReadme() throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		String out = qs.getSingleRepository(new MarkdownSummarizer(SummaryLevel.SUBITEM, new ProjectInfo()), ORG,
				"symphonyelectron");
		System.out.println(out);
	}
	...
	public void testWholeReadme() throws Exception {
		Map<String, String> out = readme.generateInner();
	...
	@Test
	public void testDifferentlyNamedReadme()
			throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		String out = qs.getSingleRepository(new MarkdownSummarizer(SummaryLevel.SUBITEM, new ProjectInfo()), ORG,
				"kdb-studio");
		System.out.println(out);
	...
	public void testCommit() throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		cs.commitFile("somefile.md", "This is some contents".getBytes(), "generated-branch", "landscape-scanning",
				"robmoffat");
	}

	@Test
	public void testPR() throws GraphQLRequestExecutionException, GraphQLRequestPreparationException {
		pr.createOrUpdatePullRequest("landscape-scanning", "robmoffat", "main", "generated-branch",
				Arrays.asList("@robmoffat"), "Get this merged");
		pr.createOrUpdatePullRequest("landscape-scanning", "robmoffat", "main", "generated-branch",
				Arrays.asList("@robmoffat"), "new comment");
